...
namespace JavaFlorist.Repositories.Services.Mail
{
    public class MailService : IMailService
    {
        ...
        public async Task<bool> SendWithAttachmentsAsync(MailDataWithAttacments mailData, CancellationToken ct = default)
        {
            try
            {
        ...
        public async Task<bool> SendMailAsync(VoucherMail mailData, CancellationToken ct = default)
        {
            try
            {
                // Initialize a new instance of the MimeKit.MimeMessage class
